...
class Profile implements \JsonSerializable {
    ...
    /**
     *Why is there no "string" atached to newprofileid. Also why is there a question mark on the first "string"? Why is there no message for the "throw get message?
     * I don't understand the "0,$exception" thing
     */
